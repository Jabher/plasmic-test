...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Et5NoByz1kk/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: htiHErbdUDG/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: FA5YgsugGFe/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__kXd1)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fcHcq)}
                role={"img"}
              />
            ),
